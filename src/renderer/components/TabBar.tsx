...
import {
  TAB_BAR_BUTTON_WIDTH_PX,
  TAB_BAR_GAP_PX,
  getTabStripIdealWidth,
...
export default memo(function TabBar({
  ...
  const updateScrollState = useCallback(() => {
    ...
    const next = {
      ...
      canScrollRight:
        isOverflowing && scrollLeft + clientWidth < scrollWidth - 1,
      isOverflowing,
    };
    setScrollState((prev) => {
      if (
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (fallbackMeasureInterval !== null)
        window.clearInterval(fallbackMeasureInterval);
    };
        ...
        {scrollState.isOverflowing && (
          <>
            <button
              ...
              style={{
                width: TAB_BAR_BUTTON_WIDTH_PX,
                height: TAB_BAR_BUTTON_WIDTH_PX,
              }}
